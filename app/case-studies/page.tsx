...
import AnimatedGradient, { caseStudyBlobs } from "../components/AnimatedGradient";
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      <main className="mx-auto max-w-4xl px-6 py-8 sm:py-16">
        <AnimatedGradient className="mb-8 sm:mb-10 h-36 sm:h-48 w-full" blobs={caseStudyBlobs} />
        <Breadcrumb crumbs={[{ label: "Home", href: "/" }, { label: "Case Studies" }]} />
